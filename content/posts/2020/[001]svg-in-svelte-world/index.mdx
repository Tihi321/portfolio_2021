...
![Road Trip](assets/svg-roadtrip.gif)
...
<SandboxBlock title="Smile" src="https://glitch.com/embed/#!/embed/svelte-path-morph?path=src/components/app.html&previewSize=30&sidebarCollapsed=true" permissions={["geolocation", "microphone", "camera", "midi", "en", "encrypted-media"]}/>
...
<SandboxBlock style={{height: "410px"}} title="Rain" src="https://glitch.com/embed/#!/embed/svelte-rain-animation?path=src/components/app.html&previewSize=100&sidebarCollapsed=true" permissions={["geolocation", "microphone", "camera", "midi", "en", "encrypted-media"]}/>
