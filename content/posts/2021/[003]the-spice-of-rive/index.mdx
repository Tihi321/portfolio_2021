...
Well enough for this time, hopefuly this has shown some of the things Rive can do, personaly I will continue to use it in the future. But it is time for a new challenge. So until next time happy coding.
